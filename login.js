...
const Login = () => {
  ...
  function submitForm(e) {
    ...
    function valider() {
      ...
      const validUser = loading.find((user) => user.email === username && user.password === password);
      ...
      if (!username || !password) {
        ...
        toast.warning("Mauvais identifiant ou mot de passe");
      }
    };
  return (
    <div className="container">
      <center>
      <form class="form_container" onSubmit={submitForm}>
  ...
  <div class="input_container">
    ...
    <input placeholder="name@mail.com" title="Inpit title" name="input-name"  class="input_field" id="email_field" type="text"value={username}          onChange={(e) => setUsername(e.target.value)} />
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="input-name" class="input_field" id="password_field" type="password" value={password} onChange={(e) => setPassword(e.target.value)}/>
    
  </div>
  <button onClick={valider} className='btn btn-success'>Sing In</button>
  <button className='btn btn-primary' onClick={()=>navigate('/user')}>Sign Up</button>
